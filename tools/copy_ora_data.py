...
if copyTable(engineBCPVS, 'bcpvs.batch', 'batch'):
    cur.execute("ALTER TABLE bcpvs.batch Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
#    cur.execute("ALTER TABLE bcpvs.jcmol_moltable Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
#
#    try:
...
if copyTable(engineBCPVS, 'bcpvs.external_id', 'external_id'):
    ...
    cur.execute("ALTER TABLE bcpvs.external_id Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineBCPVS, 'bcpvs.lcb_batch', 'lcb_batch'):
    cur.execute("ALTER TABLE bcpvs.lcb_batch Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineBCPVS, 'bcpvs.structure_change_log', 'structure_change_log'):
    cur.execute("ALTER TABLE bcpvs.structure_change_log Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineSCREEN, 'screen.aa_cyp3a4_stab', 'aa_cyp3a4_stab'):
    cur.execute("ALTER TABLE screen.aa_cyp3a4_stab Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineSCREEN, 'screen.aa_elph_1', 'aa_elph_1'):
    cur.execute("ALTER TABLE screen.aa_elph_1 Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineSCREEN, 'screen.aa_ez4u_screen', 'aa_ez4u_screen'):
    cur.execute("ALTER TABLE screen.aa_ez4u_screen Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.aa_ez4u_screen
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.aa_induction', 'aa_induction'):
    cur.execute("ALTER TABLE screen.aa_induction Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.aa_induction
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.aa_ips', 'aa_ips'):
    cur.execute("ALTER TABLE screen.aa_ips Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineSCREEN, 'screen.aa_ltssolubility', 'aa_ltssolubility'):
    cur.execute("ALTER TABLE screen.aa_ltssolubility Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.aa_ltssolubility
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.aa_metstab', 'aa_metstab'):
    cur.execute("ALTER TABLE screen.aa_metstab Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.aa_metstab
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.aa_mmt_ames', 'aa_mmt_ames'):
    cur.execute("ALTER TABLE screen.aa_mmt_ames Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.aa_mmt_ames
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.aa_p450inhib', 'aa_p450inhib'):
    cur.execute("ALTER TABLE screen.aa_p450inhib Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.aa_p450inhib
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.aa_permeabilitet', 'aa_permeabilitet'):
    cur.execute("ALTER TABLE screen.aa_permeabilitet Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.aa_permeabilitet
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.aa_pka', 'aa_pka'):
    cur.execute("ALTER TABLE screen.aa_pka Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.aa_pka
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.aa_protein_binding', 'aa_protein_binding'):
    cur.execute("ALTER TABLE screen.aa_protein_binding Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.aa_protein_binding
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.aa_solubility', 'aa_solubility'):
    cur.execute("ALTER TABLE screen.aa_solubility Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineSCREEN, 'screen.aa_spec_analysis', 'aa_spec_analysis'):
    cur.execute("ALTER TABLE screen.aa_spec_analysis Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.aa_spec_analysis
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.ba_binding_sp', 'ba_binding_sp'):
    cur.execute("ALTER TABLE screen.ba_binding_sp Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.ba_binding_sp
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.ba_ca_ic50', 'ba_ca_ic50'):
    cur.execute("ALTER TABLE screen.ba_ca_ic50 Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.ba_ca_ic50
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.ba_ca_sp', 'ba_ca_sp'):
    cur.execute("ALTER TABLE screen.ba_ca_sp Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.ba_ca_sp
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.ba_camp_efficacy', 'ba_camp_efficacy'):
    cur.execute("ALTER TABLE screen.ba_camp_efficacy Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.ba_camp_efficacy
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.ba_cell_sp', 'ba_cell_sp'):
    cur.execute("ALTER TABLE screen.ba_cell_sp Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.ba_cell_sp
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.ba_enz_inh_comp', 'ba_enz_inh_comp'):
    cur.execute("ALTER TABLE screen.ba_enz_inh_comp Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.ba_enz_inh_comp
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.ba_enzyme_sp', 'ba_enzyme_sp'):
    cur.execute("ALTER TABLE screen.ba_enzyme_sp Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.ba_enzyme_sp
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.ba_functional_dr', 'ba_functional_dr'):
    cur.execute("ALTER TABLE screen.ba_functional_dr Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.ba_functional_dr
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.ba_herg_dr', 'ba_herg_dr'):
    cur.execute("ALTER TABLE screen.ba_herg_dr Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.ba_herg_dr
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.ba_herg_sp', 'ba_herg_sp'):
    cur.execute("ALTER TABLE screen.ba_herg_sp Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.ba_herg_sp
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.ba_hit_88', 'ba_hit_88'):
    cur.execute("ALTER TABLE screen.ba_hit_88 Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.ba_hit_88
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.ba_hts_80_2', 'ba_hts_80_2'):
    cur.execute("ALTER TABLE screen.ba_hts_80_2 Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")

    cur.execute("""ALTER TABLE screen.ba_hts_80_2
                   ADD FOREIGN KEY (compound_id) REFERENCES bcpvs.compound(compound_id)""")
##
if copyTable(engineSCREEN, 'screen.ba_radio_sp', 'ba_radio_sp'):
    cur.execute("ALTER TABLE screen.ba_radio_sp Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineSCREEN, 'screen.ba_rec_ec50', 'ba_rec_ec50'):
    cur.execute("ALTER TABLE screen.ba_rec_ec50 Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineCOOL, 'cool.config', 'config'):
    ...
    cur.execute("""ALTER TABLE cool.config ADD FOREIGN KEY (config_id) REFERENCES cool.plate(config_id)""")
...
if copyTable(engineASSAY, 'assay.ba_bf_camp_dr', 'ba_bf_camp_dr'):
    ...
    cur.execute("ALTER TABLE assay.ba_bf_camp_dr Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineASSAY, 'assay.ba_bf_camp_sp', 'ba_bf_camp_sp'):
    ...
    cur.execute("ALTER TABLE assay.ba_bf_camp_sp Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineASSAY, 'assay.ba_biofocus_dr', 'ba_biofocus_dr'):
    ...
    cur.execute("ALTER TABLE assay.ba_biofocus_dr Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineASSAY, 'assay.ba_biofocus_sp', 'ba_biofocus_sp'):
    ...
    cur.execute("ALTER TABLE assay.ba_biofocus_sp Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineASSAY, 'assay.ba_mds_dr', 'ba_mds_dr'):
    ...
    cur.execute("ALTER TABLE assay.ba_mds_dr Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineASSAY, 'assay.cerep_functional_dr', 'cerep_functional_dr'):
    ...
    cur.execute("ALTER TABLE assay.cerep_functional_dr Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineASSAY, 'assay.cerep_functional_sp', 'cerep_functional_sp'):
    ...
    cur.execute("ALTER TABLE assay.cerep_functional_sp Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineASSAY, 'assay.cerep_ki', 'cerep_ki'):
    ...
    cur.execute("ALTER TABLE assay.cerep_ki Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineASSAY, 'assay.cerep_screen', 'cerep_screen'):
    ...
    cur.execute("ALTER TABLE assay.cerep_screen Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineASSAY, 'assay.lcb_dr', 'lcb_dr'):
    ...
    cur.execute("ALTER TABLE assay.lcb_dr Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineASSAY, 'assay.lcb_sp_schneider_cysm', 'lcb_sp_schneider_cysm'):
    ...
    cur.execute("ALTER TABLE assay.lcb_sp_schneider_cysm Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineASSAY, 'assay.metabolite', 'metabolite'):
    ...
    cur.execute("ALTER TABLE assay.metabolite Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
...
if copyTable(engineASSAY, 'assay.upstate_sp', 'upstate_sp'):
    ...
    cur.execute("ALTER TABLE assay.upstate_sp Modify column compound_id varchar(26) CHARACTER SET utf8 COLLATE utf8_bin")
