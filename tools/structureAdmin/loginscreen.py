...
from editStructure import EditStructure
...
class LoginScreen(QDialog):
    def __init__(self):
        ...
        loadUi(resource_path("assets/loginscreen.ui"), self)
    ...
    def gotoEdit(self, token):
        search = EditStructure(token)
